/**
 * Vrátí stav hodnoty vůči prahovým hodnotám
...
export const isInRange = (value, min, max) =>
  getThresholdStatus(value, min, max) === 'ok';

/**
 * Tailwind třídy podle stavu – použiješ přímo v komponentách
 */
...
/**
 * Vrátí styly pro konkrétní hodnotu
 */
